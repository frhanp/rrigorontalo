...
<body class="antialiased text-slate-800 font-sans">
    <div class="container mx-auto px-4">
        {{-- HEADER UTAMA DENGAN TAMBAHAN LINK MEDIA SOSIAL --}}
        <header class="flex justify-between items-center py-6">
            ...
            <nav class="hidden sm:flex items-center text-sm font-medium space-x-6">
                {{-- Bagian Login/Register/Dashboard --}}
                @auth
        ...
        {{-- NAVBAR KATEGORI DENGAN TAMBAHAN LINK ARSIP --}}
        <nav class="bg-white/70 backdrop-blur-lg sticky top-4 z-50 rounded-xl mb-10 border border-slate-200 shadow-md">
            <ul class="flex justify-center items-center p-2 space-x-1 overflow-x-auto">
                ...
                {{-- === TAMBAHAN LINK ARSIP === --}}
                 <li>
                    @php $isArsipActive = request()->routeIs('posts.archive'); @endphp
                    <a href="{{ route('posts.archive') }}" 
                       class="block px-4 py-2 text-sm font-bold rounded-lg transition-all duration-200 whitespace-nowrap {{ $isArsipActive ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:bg-blue-100 hover:text-blue-700' }}">
                        ARSIP
                    </a>
                </li>
            </ul>
        ...
        {{-- FOOTER BARU --}}
        {{-- FOOTER BARU YANG LEBIH INTERAKTIF --}}
<footer class="text-center py-10 mt-12 bg-white border-t border-slate-200">
    <div class="container mx-auto px-4">
        ...
        {{-- TOMBOL MEDIA SOSIAL DENGAN IKON + TEKS --}}
