...
<head>
    ...
    <style>
        ...
        /* === CSS BARU UNTUK MEMPERCANTIK AUDIO PLAYER === */
        .prose audio {
            width: 100%;
            /* Agar lebarnya penuh */
            background-color: #f1f5f9;
            /* Warna latar belakang slate-100 */
            border-radius: 0.5rem;
            /* Sudut membulat */
            border: 1px solid #e2e8f0;
            /* Garis tepi slate-200 */
            padding: 0.25rem;
            /* Sedikit padding */
            margin-top: 1em;
            margin-bottom: 1em;
        ...
        /* Mengubah warna track di Chrome */
...
<body class="antialiased text-slate-800 font-sans">
    <div class="container mx-auto px-4">
        ...
        <footer class="text-center py-10 mt-12 bg-white border-t border-slate-200">
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex justify-center items-center space-x-4">
                    <a href="https://www.youtube.com/@RRIGORONTALOSTREAMING" target="_blank"
                        ...
                        <svg class="w-5 h-5 mr-2 transition-colors group-hover:text-white" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
                                d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0C.887 3.427 0 4.926 0 8.75v6.5C0 19.074.887 20.573 4.385 20.816c3.6.245 11.626.246 15.23 0 3.5-.243 4.385-1.742 4.385-5.566v-6.5c0-3.823-.885-5.322-4.385-5.566zm-10.615 12.566v-9.132l7.92 4.566-7.92 4.566z">
                            </path>
                        </svg>
                        <span>YouTube</span>
                    </a>
                ...
                <p class="mt-8 text-sm text-slate-500">&copy; {{ date('Y') }} RRI Gorontalo. Semua Hak Cipta
                    Dilindungi.</p>
            </div>
        </footer>
    </div>
    ...
    {{-- Untuk memuat script dari halaman lain (seperti TinyMCE) --}}
    @stack('scripts')
