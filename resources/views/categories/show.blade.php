        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="space-y-10">
                    ...
                    @empty
                        <div class="bg-white p-10 rounded-lg shadow-sm border border-slate-200"><p class="text-center text-slate-500">Belum ada berita yang ditemukan dalam kategori ini.</p></div>
                    @endforelse
                </div>
                <div class="mt-10">
