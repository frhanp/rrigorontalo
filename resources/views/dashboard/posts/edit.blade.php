        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-slate-900">
                <form method="POST" action="{{ route('dashboard.posts.update', $post) }}" enctype="multipart/form-data">
                    ...
                    <!-- Media -->
                    <div class="mt-4">
                        <x-input-label for="media" :value="__('Ganti Media (Gambar/Video/Audio)')" />
                        @if ($post->media)
                            <div class="my-2">
                                <p class="text-sm text-slate-600">Media saat ini:</p>
                        ...
                        <p class="text-xs text-slate-500 mt-1">Kosongkan jika tidak ingin mengganti media.</p>
                    </div>
